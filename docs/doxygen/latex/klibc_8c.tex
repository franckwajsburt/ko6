\hypertarget{klibc_8c}{\section{/users/enseig/franck/ko6/src/soft/kernel/klibc.c File Reference}
\label{klibc_8c}\index{/users/enseig/franck/ko6/src/soft/kernel/klibc.\-c@{/users/enseig/franck/ko6/src/soft/kernel/klibc.\-c}}
}
{\ttfamily \#include $<$kernel/klibc.\-h$>$}\\*
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
\#define \hyperlink{klibc_8c_a61a6808df75b050d8f8966eb68c10f2a}{randseed}~$\ast$(\hyperlink{kthread_8h_ac8ecc48f4f6134c6118c90a593b187bc}{thread\-\_\-krandseed}(\hyperlink{kthread_8h_a1da5431310f6068f6d1113c402eff5f8}{Thread\-Current}))   /$\ast$ Thread Local Storage for the kernel $\ast$/
\end{DoxyCompactItemize}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
int \hyperlink{klibc_8c_ae23144bcbb8e3742b00eb687c36654d1}{rand} (void)
...
void \hyperlink{klibc_8c_a210f1bb7dc29a87394a25027e4231004}{srand} (unsigned seed)
\begin{DoxyCompactList}\small\item\em allow to define a specific random suite \end{DoxyCompactList}\item 
void \hyperlink{klibc_8c_a3643d04c418455ae56f321c6d12f8da8}{delay} (unsigned nbcycles)
\begin{DoxyCompactList}\small\item\em stop until a delay mesured in cycles \end{DoxyCompactList}\item 
int \hyperlink{klibc_8c_ac4ae3bb8e59735d2b772e77186b52228}{kprintf} (char $\ast$fmt,...)
...
void \hyperlink{klibc_8c_a55e99c539cf7723ec15e856b7e0a8cee}{exit} (int status)
\begin{DoxyCompactList}\small\item\em exit the application, thus never returns \end{DoxyCompactList}\item 
int \hyperlink{klibc_8c_a4e745df503033a3297f150e02f27fabb}{tty\-\_\-read} (int tty, char $\ast$buf, unsigned count)
...
int \hyperlink{klibc_8c_a528bdbe20981259789b7663d15278ba4}{tty\-\_\-write} (int tty, char $\ast$buf, unsigned count)
...
int \hyperlink{klibc_8c_acbec5f4fe563ba73dd03635c2194b92a}{tty\-\_\-putc} (int tty, int c)
\begin{DoxyCompactList}\small\item\em write a single char to the tty \end{DoxyCompactList}\item 
int \hyperlink{klibc_8c_a67e98fd7f3b38a6b00f505ea7fc76bc1}{tty\-\_\-getc} (int tty)
\begin{DoxyCompactList}\small\item\em read a single char from the tty \end{DoxyCompactList}\item 
int \hyperlink{klibc_8c_a93cda08fc734f6ecd64519a4cf673f40}{tty\-\_\-puts} (int tty, char $\ast$buf)
\begin{DoxyCompactList}\small\item\em send all char of a buffer to the tty until a 0 is found \end{DoxyCompactList}\item 
int \hyperlink{klibc_8c_aebeb4a7ee9e0b0506d4ae55f66cb5422}{tty\-\_\-gets} (int tty, char $\ast$buf, int count)
...
int \hyperlink{klibc_8c_a9d82a64f65502ac9554fc0c28b8f1f44}{fifo\-\_\-push} (struct \hyperlink{structfifo__s}{fifo\-\_\-s} $\ast$fifo, char c)
\begin{DoxyCompactList}\small\item\em push a character into the chardev's F\-I\-F\-O \end{DoxyCompactList}\item 
int \hyperlink{klibc_8c_a95fd51dea7c9c02c2e2e1e9ad2333684}{fifo\-\_\-pull} (struct \hyperlink{structfifo__s}{fifo\-\_\-s} $\ast$fifo, int $\ast$c)
...
\hypertarget{klibc_8c_a61a6808df75b050d8f8966eb68c10f2a}{\index{klibc.\-c@{klibc.\-c}!randseed@{randseed}}
\index{randseed@{randseed}!klibc.c@{klibc.\-c}}
\subsubsection[{randseed}]{\setlength{\rightskip}{0pt plus 5cm}\#define randseed~$\ast$({\bf thread\-\_\-krandseed}({\bf Thread\-Current}))   /$\ast$ Thread Local Storage for the kernel $\ast$/}}\label{klibc_8c_a61a6808df75b050d8f8966eb68c10f2a}
...
\hypertarget{klibc_8c_a3643d04c418455ae56f321c6d12f8da8}{\index{klibc.\-c@{klibc.\-c}!delay@{delay}}
\index{delay@{delay}!klibc.c@{klibc.\-c}}
\subsubsection[{delay}]{\setlength{\rightskip}{0pt plus 5cm}void delay (
\begin{DoxyParamCaption}
\item[{unsigned}]{nbcycles}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a3643d04c418455ae56f321c6d12f8da8}
...
35 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a55e99c539cf7723ec15e856b7e0a8cee}{\index{klibc.\-c@{klibc.\-c}!exit@{exit}}
\index{exit@{exit}!klibc.c@{klibc.\-c}}
\subsubsection[{exit}]{\setlength{\rightskip}{0pt plus 5cm}void exit (
\begin{DoxyParamCaption}
\item[{int}]{status}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a55e99c539cf7723ec15e856b7e0a8cee}
...
51 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a95fd51dea7c9c02c2e2e1e9ad2333684}{\index{klibc.\-c@{klibc.\-c}!fifo\-\_\-pull@{fifo\-\_\-pull}}
\index{fifo\-\_\-pull@{fifo\-\_\-pull}!klibc.c@{klibc.\-c}}
\subsubsection[{fifo\-\_\-pull}]{\setlength{\rightskip}{0pt plus 5cm}int fifo\-\_\-pull (
\begin{DoxyParamCaption}
\item[{struct {\bf fifo\-\_\-s} $\ast$}]{fifo, }
\item[{int $\ast$}]{c}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a95fd51dea7c9c02c2e2e1e9ad2333684}
...
153 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a9d82a64f65502ac9554fc0c28b8f1f44}{\index{klibc.\-c@{klibc.\-c}!fifo\-\_\-push@{fifo\-\_\-push}}
\index{fifo\-\_\-push@{fifo\-\_\-push}!klibc.c@{klibc.\-c}}
\subsubsection[{fifo\-\_\-push}]{\setlength{\rightskip}{0pt plus 5cm}int fifo\-\_\-push (
\begin{DoxyParamCaption}
\item[{struct {\bf fifo\-\_\-s} $\ast$}]{fifo, }
\item[{char}]{c}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a9d82a64f65502ac9554fc0c28b8f1f44}
...
143 \}
\end{DoxyCode}
\hypertarget{klibc_8c_ac4ae3bb8e59735d2b772e77186b52228}{\index{klibc.\-c@{klibc.\-c}!kprintf@{kprintf}}
\index{kprintf@{kprintf}!klibc.c@{klibc.\-c}}
\subsubsection[{kprintf}]{\setlength{\rightskip}{0pt plus 5cm}int kprintf (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{fmt, }
\item[{}]{...}
\end{DoxyParamCaption}
)}}\label{klibc_8c_ac4ae3bb8e59735d2b772e77186b52228}
...
46 \}
\end{DoxyCode}
\hypertarget{klibc_8c_ae23144bcbb8e3742b00eb687c36654d1}{\index{klibc.\-c@{klibc.\-c}!rand@{rand}}
\index{rand@{rand}!klibc.c@{klibc.\-c}}
\subsubsection[{rand}]{\setlength{\rightskip}{0pt plus 5cm}int rand (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)}}\label{klibc_8c_ae23144bcbb8e3742b00eb687c36654d1}
...
21 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a210f1bb7dc29a87394a25027e4231004}{\index{klibc.\-c@{klibc.\-c}!srand@{srand}}
\index{srand@{srand}!klibc.c@{klibc.\-c}}
\subsubsection[{srand}]{\setlength{\rightskip}{0pt plus 5cm}void srand (
\begin{DoxyParamCaption}
\item[{unsigned}]{seed}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a210f1bb7dc29a87394a25027e4231004}
...
26 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a67e98fd7f3b38a6b00f505ea7fc76bc1}{\index{klibc.\-c@{klibc.\-c}!tty\-\_\-getc@{tty\-\_\-getc}}
\index{tty\-\_\-getc@{tty\-\_\-getc}!klibc.c@{klibc.\-c}}
\subsubsection[{tty\-\_\-getc}]{\setlength{\rightskip}{0pt plus 5cm}int tty\-\_\-getc (
\begin{DoxyParamCaption}
\item[{int}]{tty}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a67e98fd7f3b38a6b00f505ea7fc76bc1}
...
90 \}
\end{DoxyCode}
\hypertarget{klibc_8c_aebeb4a7ee9e0b0506d4ae55f66cb5422}{\index{klibc.\-c@{klibc.\-c}!tty\-\_\-gets@{tty\-\_\-gets}}
\index{tty\-\_\-gets@{tty\-\_\-gets}!klibc.c@{klibc.\-c}}
...
\item[{int}]{count}
\end{DoxyParamCaption}
)}}\label{klibc_8c_aebeb4a7ee9e0b0506d4ae55f66cb5422}
...
132 \}
\end{DoxyCode}
\hypertarget{klibc_8c_acbec5f4fe563ba73dd03635c2194b92a}{\index{klibc.\-c@{klibc.\-c}!tty\-\_\-putc@{tty\-\_\-putc}}
\index{tty\-\_\-putc@{tty\-\_\-putc}!klibc.c@{klibc.\-c}}
\subsubsection[{tty\-\_\-putc}]{\setlength{\rightskip}{0pt plus 5cm}int tty\-\_\-putc (
\begin{DoxyParamCaption}
\item[{int}]{tty, }
\item[{int}]{c}
\end{DoxyParamCaption}
)}}\label{klibc_8c_acbec5f4fe563ba73dd03635c2194b92a}
...
82 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a93cda08fc734f6ecd64519a4cf673f40}{\index{klibc.\-c@{klibc.\-c}!tty\-\_\-puts@{tty\-\_\-puts}}
\index{tty\-\_\-puts@{tty\-\_\-puts}!klibc.c@{klibc.\-c}}
\subsubsection[{tty\-\_\-puts}]{\setlength{\rightskip}{0pt plus 5cm}int tty\-\_\-puts (
\begin{DoxyParamCaption}
\item[{int}]{tty, }
\item[{char $\ast$}]{buf}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a93cda08fc734f6ecd64519a4cf673f40}
...
97 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a4e745df503033a3297f150e02f27fabb}{\index{klibc.\-c@{klibc.\-c}!tty\-\_\-read@{tty\-\_\-read}}
\index{tty\-\_\-read@{tty\-\_\-read}!klibc.c@{klibc.\-c}}
...
\item[{unsigned}]{count}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a4e745df503033a3297f150e02f27fabb}
...
64 \}
\end{DoxyCode}
\hypertarget{klibc_8c_a528bdbe20981259789b7663d15278ba4}{\index{klibc.\-c@{klibc.\-c}!tty\-\_\-write@{tty\-\_\-write}}
\index{tty\-\_\-write@{tty\-\_\-write}!klibc.c@{klibc.\-c}}
...
\item[{unsigned}]{count}
\end{DoxyParamCaption}
)}}\label{klibc_8c_a528bdbe20981259789b7663d15278ba4}
